...
val AfternoonBackground = AppColors.AfternoonBackground
val EveningBackground = AppColors.EveningBackground

/** Legacy Material seed colors (previews / dynamic color fallback paths). */
